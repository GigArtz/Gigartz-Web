    ...
    <div>
      ...
      {isModalOpen && (
        <div
          ...
          className="fixed top-0 left-0 right-0 z-40 flex justify-center items-center px-5 md:px-2  w-full h-full bg-black bg-opacity-50 backdrop-blur-sm transition-all duration-300 ease-in-out"
        >
          <div
