...
function Header({ title, onBack, showBackButton = true }: HeaderProps) {
  ...
  return (
    <div className="group md:flex hidden items-center mb-6 p-4 gap-5 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white rounded-2xl shadow-2xl border border-gray-700/50 backdrop-blur-sm transition-all duration-300 hover:shadow-teal-500/10 hover:border-teal-500/30">
      {showBackButton && (
        <button
          onClick={handleBack}
