  ...
  return (
    <div className="main-content p-6 animate-fade-in-up">
      <div className="relative flex justify-end h-20 mb-12 top-0">
        ...
        {/* Floating action button + menu with enhanced animations */}
        <div className="relative md:flex items-center justify-center h-full me-4 hidden animate-bounce-in animation-delay-500">
          <button
            onClick={() => {
